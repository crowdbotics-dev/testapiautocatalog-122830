...
## Project Structure
    ...
    ├── testapiautocatalog_122830  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_122830`
...
2. Clone this repo and `cd testapiautocatalog_122830`
